...
l=0.125; % initial width of the domain
epsilon=2; % random number to initialize the loop
error=0.03; % desired RMAE (stopping criteria)
...
psi0_surr_vec1=[];%storing optimal psi0 from surrogate model using original odes
...
psi1_surr_vec1=[]; %storing optimal psi1 from surrogate model using original odes
...
psi1_surr_vec1=[psi1_surr_vec1;psi1_surr1]; 
